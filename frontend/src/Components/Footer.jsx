...
// const Footer = () => {
//   return (
//     <footer className="pattern-background relative text-black pt-8 pb-6">
//       <div className="container mx-auto px-4">
//         <div className="flex flex-col lg:flex-row text-left lg:text-left ">
//           {/* Social Media Section */}
//           <div className="w-full lg:w-1/2 px-4">
//             <div>
//               <img src={logo} alt="Logo" className="h-25 mb-3" />
//             </div>
//             <div>
//               <h4>Let's keep in touch!</h4>
//               {/* <h5 className="mt-0 mb-2 text-main">Follow Julia Rose on social media</h5> */}
//               <div className="mt-3 lg:mb-0 mb-6 flex">
//                 {/* facebook */}
//                 <button className="bg-white hover:opacity-50 h-10 w-10 flex items-center justify-center rounded-full outline-none focus:outline-none mr-2">
...
//           {/* Linktree */}
//           <div className="w-fit lg:w-1/2 px-4">
//             <div className="flex flex-wrap items-top mb-2 lg:gap-0 gap-6">
//               <div className="w-fit lg:w-1/2 px-4 ml-auto">
...
//                     [
//                       "MIT License",
//                       "https://github.com/creativetimofficial/notus-js/blob/main/LICENSE.md?ref=njs-profile",
//                     ],
...
//           <div className="w-full w-4/12 px-4 mx-auto text-center">
//             <div className="text-sm text-gray-600 font-semibold py-1">
//               © 2024
//               <a
//                 href="https://www.gulfcoastwdd.com"
//                 target="_blank"
//                 rel="noreferrer"
//                 className="text-gray-900 hover:underline ps-1"
//               >
//                 Gulf Coast Web Designs & Development
//               </a>
//             </div>
//           </div>
//         </div>
