        ...
        <div className="bg-white/50 pt-40 pb-40 p-10 rounded-lg absolute right-96">
          ...
          <div className="grid grid-cols-2 justify-evenly">
            <div className="relative mb-12 px-5 lg:mb-10">
              ...
              <h6 className="font-body font-bold uppercase mb-0 dark:text-neutral-50 text-center">
            ...
            <div className="relative mb-12 px-5 lg:mb-10">
              ...
              <h6 className="mb-0 font-body font-bold uppercase dark:text-neutral-50 text-center">
            ...
            <div className="relative mb-12 px-5 lg:mb-0">
              <div className="mb-2 flex justify-center">
                <span>
                  <img src={rating} alt="star" className="h-10 w-10" />
                </span>
              </div>
              {/* <h5 className="mb-2 font-bold font-body text-center"></h5> */}
              <h6 className="mb-0 font-bold font-body uppercase dark:text-neutral-50 text-center">
