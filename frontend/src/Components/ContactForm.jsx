              ...
              <div className="col-span-2 mb-0">
                ...
                <div className="mt-1">
                  <input
                    ...
                    className="block w-full bg-gray-50 px-3.5 py-3.5 text-base text-gray-900 outline-1 -outline-offset-1 dark:outline-gray-900 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-main"
                  />
                </div>
              </div>
              {/* Email Input */}
              ...
              <Field className="flex gap-x-4 col-span-2 mb-0">
                <div className="flex h-6 items-center">
                  <Checkbox
                    checked={enabled}
                    onChange={setEnabled}
                    className="group block size-4 border bg-white data-[checked]:bg-main dark:bg-white/15 dark:border-white/15"
                  >
                    {/* Checkmark icon */}
                    <svg
