...
const PortfolioCards = () => {
  ...
  return (
    <div className="bg-white shadow-xl rounded-lg grid grid-cols-1 lg:grid-cols-4 gap-5 m-10">
      {/* portfolio cards */}

      {/* First card */}
      <figure className="relative w-full h-full flex p-1 ">
        <img
          className="object-cover object-center .max-w-full .h-auto flex-shrink rounded-xl shadow-lg shadow-black/55"
          src={grad}
          alt="senior"
        />
        <figcaption className="absolute bottom-4 inset-x-0 mx-4 flex-col lg:flex-row justify-between items-center rounded-xl border border-white bg-white/75 p-3 shadow-lg shadow-black/5 saturate-200 backdrop-blur-sm flex">
          <div className="text-center md:text-left">
            <p className="mt-0 font-body uppercase md:text-base text-sm font-normal leading-relaxed black hidden sm:flex">
              Senior Portraits
            </p>
            <button
              onClick={handleClick}
